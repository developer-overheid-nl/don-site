...
const tiles: HomepageTile[] = [
  ...
  },
  {
    ...
    description: [
      ...
      { link: '/code-for-nl', label: 'Code for NL' },
      { link: '/digilab', label: 'Digilab' },
      { link: '/opensourcewerken', label: 'Opensourcewerken' },
      { link: '/federatief-datastelsel', label: 'Federatief Datastelsel' },
      { link: '/gebruiker-centraal', label: 'Gebruiker Centraal' },
