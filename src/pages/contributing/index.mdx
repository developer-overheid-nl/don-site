import ContributingTiles from "../../components/ContributingTiles";
...
Raadpleeg
[ons artikel over CONTRIBUTING.md](/kennisbank/open-source/standaarden/contributing-md)
...
Lees de uitgebreide richtlijnen per type bijdrage:

- **[Kennisbankartikel schrijven](/contributing/kennisbank-artikel)** — bevat
  informatie over de mappenstructuur, content types, tagging, en de verwachte
  sectieopbouw per artikeltype.
- **[Gastblog schrijven](/contributing/gastblog-schrijven)** — bevat informatie
  over het format en de aanlevermethoden voor blogposts.

### Content types

Elk artikel in de kennisbank heeft een `content_type` in de frontmatter. Dit
bepaalt in welke overzichten het artikel verschijnt:
...
We hanteren een tagging strategie met 4 lagen. Elk artikel heeft minimaal 1 en
maximaal 3 **thema-tags** en optioneel onderwerp- en organisatietags (maximaal 8
tags totaal). Alle tags moeten voorkomen in `tags.yml`. Zie de
[kennisbankartikel-pagina](/contributing/kennisbank-artikel#tags) voor de
volledige uitleg.
