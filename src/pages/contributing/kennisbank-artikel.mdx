...
### Nummer stappen als "5.", niet als "Stap 5"

Gebruik in een stappenplan koppen met de notatie `N.` (bijvoorbeeld `### 5.
Titel van de stap`), niet `### Stap 5` of andere varianten.

```markdown
✓ ### 5. Valideer je bestand
✗ ### Stap 5 - Valideer je bestand
```
