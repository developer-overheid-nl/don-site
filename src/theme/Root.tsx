...
function Root({ children }: PropsWithChildren<object>) {
      ...
      <header className="ro-header container">
        ...
        >
          <div className="ro-header__word-mark">
            <svg
              className="ro-header__site-logo"
              aria-label="Vignet"
              viewBox="0 0 92 75"
              fill="none"
  ...
  `,
              ...
              <path
                ...
                fillRule="evenodd"
                clipRule="evenodd"
                d="M26.718 33.2523L0 7.9528L7.15601 0L42.1354 33.3897L34.5678 40.6854L34.5678 40.6853L7.95278 66.783L0.400269 58.8302L26.718 33.2523Z"
                fill="Currentcolor"
              />
              <path
                className="lowbar"
                d="M91.0191 64.7855H40.1378V74.7284H91.0191V64.7855Z"
                fill="CurrentColor"
              />
            </svg>
