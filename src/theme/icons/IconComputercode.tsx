 ...
 */
const IconComputercode = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 64 64"
    width="1em"
    height="1em"
    data-icon-name="computercode"
    {...props}
  >
    ...
    <path d="m26.9 43.55 2.85 1.1 7.35-20.2-2.85-1.1zM25.26 28.31l-7.76 4.7v1.98l7.76 4.7 1.55-2.71-5.07-2.99 5.08-2.97zM38.74 28.31l-1.56 2.71 5.08 2.99-5.08 2.96 1.56 2.72 7.75-4.7v-1.98z" />
  </svg>
);
