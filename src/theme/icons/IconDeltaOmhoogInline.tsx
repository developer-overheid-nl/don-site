 ...
 */
const IconDeltaOmhoogInline = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" data-icon-name="delta-omhoog-inline" {...props}><path 
  d="M.95 18.34c1.01 1.01 2.3 1.35 3.31.34l7.75-7.75 7.75 7.75c1.01 1.01 2.3.66 3.3-.34 1.01-1.01 1.35-2.3.34-3.3l-9.58-9.57a2.577 2.577 0 0 0-3.65 0L.61 15.04c-1.01 1.01-.66 2.3.34 3.3" /></svg>;
