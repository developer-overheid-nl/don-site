 ...
 */
const IconTekstballonnenMetVraagteken = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 64 64"
    width="1em"
    height="1em"
    data-icon-name="tekstballonnen-met-vraagteken"
    {...props}
  >
    ...
    <path d="M38.63 18.02c-5.06-.87-13.5-.87-15.19-.87s-10.12 0-15.19.87c-1.75.3-3.08 1.67-3.38 3.46-.84 5.19-.84 9.85-.84 11.58s0 6.39.84 11.58c.29 1.8 1.62 3.16 3.38 3.46.66.11 1.39.21 2.14.29l3.75-5.2c.2-.29.4-.1.4-.1l-3.26 11.5-.05.18c-.04.25 0 .51.15.74.31.49.96.64 1.45.33l11.25-6.88c2.57 0 9.95-.08 14.55-.86 1.75-.3 3.08-1.67 3.38-3.46.84-5.19.84-9.85.84-11.58 0-5.2 0-6.39-.84-11.58-.29-1.8-1.62-3.16-3.38-3.46M22.52 43.98c-1.6 0-2.52-.86-2.52-2.47 0-1.42.85-2.53 2.49-2.53s2.52.9 2.52 2.53c0 1.39-.85 2.47-2.49 2.47m3.42-11.59-1.59.86c-.92.49-1.33 1.1-1.33 1.78 0 .61.25 1.29.63 1.97h-3.14c-.64-.61-.92-1.41-.92-2.37 0-1.42.67-2.43 2.38-3.44l1.68-.98c1.33-.77 1.78-1.38 1.78-2.37 0-1.05-1.01-1.81-3.01-1.81-1.46 0-2.86.28-4.41.86v-3.1c1.75-.68 3.36-.98 5.33-.98 3.62 0 5.97 1.84 5.97 4.61 0 2.4-.92 3.66-3.36 4.98" />
  </svg>
);
