 ...
 */
const IconDocumentBlanco = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="1em" height="1em" data-icon-name="document-blanco" {...props}><defs><clipPath id="clippath"><path d="M0 0h64v64H0z" className="cls-1" /></clipPath><clipPath id="clippath-1"><path d="M0 0h64v64H0z" className="cls-1" /></clipPath><style>{".cls-1{fill:none}"}</style></defs><g style={{
