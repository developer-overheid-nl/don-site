...
draft: true
---
# Waarom is data delen niet eenvoudig?

Als burger wordt er vaak om jouw data gevraagd, je naam en email adres zijn vaak een vereiste voor digitale dienstverlening maar ook je adres of geboorte datum zijn nodig voor diensten, denk aan online winkels of financiele dienstverleners.

Vroeger vulde je deze data gewoon in op een (digitaal) formulier en moest de ontvanger van de data jouw vertrouwen dat de data juist waren verstrekt. Andersom moet je als burger bij het groeiend aantal dienstverleners erop vertrouwen dat die allemaal zorgvuldig omgaan met de verstrekte data.

De kern van het delen van data is daarom ook vertrouwen en vertrouwen is nu eenmaal niet zo eenvoudig als delen.
