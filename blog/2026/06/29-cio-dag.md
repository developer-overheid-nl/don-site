...
De dag werd geopend met een stevige bezetting vanuit verschillende ministeries,
...
##  Druk bezochte talks, lege gangen.

Een van de dingen die opviel (in tegenstelling tot andere grotere events) is dat
...
onderling een gesprek aan te gaan. Een positief iets, als je het mij vraagt.

## kennisplein

Het kennisplein fungeert als vraagbaak en ook sociale lijm tussen de talks door.
...
Robot-hond Adam, `tot leven` gewekt op een lokaal draaiend LLM trok bekijks, en
natuurlijk ook de nodige technische interesse. `Hoe werkt zo'n Lokaal LLM dan?`,
maar ook andere onderwerpen zoals de open source werkplek werden al snel
onderwerp van langdurige gesprekken tussen potentieele toekomstige gebruikers.

## Vervolg

Ben jij CIO binnen de (bredere overheid) of vervul je een aanpalende rol, dan is
...
moeten het tenslotte samen met elkaar oplossen.
