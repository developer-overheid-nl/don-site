---
title: "8.1. Onboarding developers"
tags: ["development"]
---
...
Uiteraard doorlopen nieuwe developers het onboarding proces. 
Eén of meer developers onderhouden het onboarding proces en de onboarding guide.
...
Verzamel in een brainstorm-sessie alles wat developers denken, weten en vinden dat een nieuwkomer zou moeten
hebben, kunnen en weten. Schrijf dit puntsgewijs op.
...
- afspraken over werkwijze, zoals de repository policy, gehanteerde standaarden, 
...
Vraag elk nieuw teamlid naar de ervaring met de onboarding.
Wat ging goed? Wat kan beter? Was het duidelijk? Klopte de informatie? 
Kijk in de loop van de eerste week terug op de eerste dag, in de loop van de eerste maand op de eerste week.

Pas het onboarding document aan.
Vraag eventueel het nieuwe teamlid hieraan bij te dragen.

Een voorbeeld van een onboarding guide voor kwaliteitsmanagers kun je vinden in
...
ICTU heeft in haar ["Kwaliteitsaanpak Softwareontwikkeling"](https://ictu.github.io/Kwaliteitsaanpak/) verschillende templates, waaronder een Word-template voor een inwerkplan voor kwaliteitsmanagers.

### Gerelateerde richtlijnen

- Developers nemen kennis van de [repository policy](../open-source/richtlijn-repository-policy.md) van je organisatie en/of team.
