...
Applicatie security tools helpen je geautomatiseerd beveiligingskwetsbaarheden te ontdekken in je eigen code of in code waar je afhankelijk van bent (dependencies) in de vorm van bijvoorbeeld bibliotheken of container images.
...
Programmeurs richten de tools in en repareren de kwetsbaarheden.
...
- OWASP Application Security Verification Standard (ASVS), versie 5.0, https://github.com/OWASP/ASVS, paragraaf 15.2, "Security Architecture and Dependencies".
- OWASP Software Assurance Maturity Model (SAMM), versie 2, https://owaspsamm.org, the Secure Build practice.
