...
- **Bescherming van gevoelige gegevens** - Overheden verwerken enorme
  hoeveelheden vertrouwelijke informatie van burgers, bedrijven en nationale
  veiligheid. Een datalek kan desastreuze gevolgen hebben.
- **Continuïteit van dienstverlening** - Overheidsdiensten zijn essentieel voor
  het functioneren van de samenleving. Uitval door cyberaanvallen kan leiden tot
  verstoring van cruciale diensten.
- **Toenemende dreiging cyberaanvallen** - Geopolitieke spanningen leiden tot
  meer gerichte aanvallen op overheidsinstanties door andere landen.
- **Naleving van wetgeving** - Overheden moeten voldoen aan strikte wetgeving
  zoals de AVG/GDPR en sectorspecifieke regelgeving.

## Gebruik van PKIoverheid-certificaten

In bepaalde situaties is gebruik van PKIoverheid-certificaten nodig of
wenselijk.

- [Richtlijn gebruik PKIoverheid-certificaten](pkioverheid.md).

## Applicatie security tools in de pijplijn

Neem applicatie security tools op in de pijplijn.

- [Richtlijn security tools](richtlijn-applicatie-security-tools.md).

## Monitoring met OpenKAT

OpenKAT is ontwikkeld om de (beveiligings-)status van informatiesystemen te
monitoren, analyseren en op te slaan.
