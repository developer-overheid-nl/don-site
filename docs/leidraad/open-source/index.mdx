...
architects, product owners, inkoop en management.

Developers schrijven en publiceren open source code. Architects bepalen welke
...
Publiceer je code op een publiek toegankelijk platform zoals GitHub, GitLab of
Gitea. Zorg dat de repository goed gedocumenteerd is met een README, licentie en
...
#### GitHub/GitLab voor code hosting

Gebruik GitHub, GitLab of een andere Git-based platform voor het hosten van je
open source code. Deze platforms bieden functionaliteit voor versiebeheeer,
issue tracking en pull requests.
...
- [Publiccode.yml](/kennisbank/open-source/publiccode-yml)
...
<Card
  appearance="default"
  description="In dit hoofdstuk van onze kennisbank vind je informatie over open source werken."
