...
Voor het uitwerken van niet-functionele eisen in relatie tot de architectuur kun je tools als Archi (dat de Archimate architectuur modeleertaal ondersteunt) gebruiken.
