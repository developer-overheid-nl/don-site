...
:::info[Verplichte standaard] Deze standaard is
...
met de [ADR Linter](./api-design-rules-linter). Als een API eenmaal in productie
is kan de [ADR Validator](./api-design-rules-validator) gebruikt worden om
bepaalde regels automatisch te valideren.

Een van de belangrijkste redenen om de API Design Rules te volgen is
