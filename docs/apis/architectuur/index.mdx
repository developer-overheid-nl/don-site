...
Dit architectuurdocument is onderdeel van de **NL API Strategie**  en biedt een verdieping op [de algemene inleiding](https://docs.geostandaarden.nl/api/API-Strategie/). De versie is opgesteld in december 2023 en is los gepositioneerd ten opzichte van de eerdere geïntegreerde versie.
