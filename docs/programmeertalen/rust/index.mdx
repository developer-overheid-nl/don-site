...
<Grid>
  <Card
    appearance="default"
    description="Bekijk meer Rust projecten om inspiratie op te doen."
    heading="Ontdek meer Rust projecten"
    href="https://oss.developer.overheid.nl/repositories?technologie=80"
    linkLabel="Naar oss.developer.overheid.nl"
  />
  <Card
    appearance="default"
    description="Artikel: deze goede redenen heeft de Kiesraad om Rust te gebruiken."
    heading="De Kiesraad over Rust"
    href="https://developer.overheid.nl/blog/2025/03/26/interview-kiesraad-rust"
