...
- [OpenAPI Specification (OAS)](/kennisbank/api-ontwikkeling/standaarden/openapi-specification) - De
  standaard voor het beschrijven van REST API's
- [API Design Rules](/kennisbank/api-ontwikkeling/standaarden/api-design-rules) - De Nederlandse
