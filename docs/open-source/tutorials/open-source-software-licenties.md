...
<details>
<summary>Contents EUPL 1.2</summary>

```txt showLineNumbers title="EUPL 1.2"
...
Een voordeel van het expliciet noemen van het licentietype is dat er dan minder
makkelijk een misverstand over kan bestaan welke licentie er op de code berust.
Echter is het een alom geaccepteerde conventie dat bestanden waarbij geen
licentie is vermeld automatisch vallen onder de licentie die wordt genoemd in
het `LICENSE` bestand.
