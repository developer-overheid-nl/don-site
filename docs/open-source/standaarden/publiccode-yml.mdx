...
<!-- TODO: ## Wanneer gebruik je dit — voeg toe wanneer je publiccode.yml gebruikt -->
...
<!-- TODO: ## Toepassing in Nederland — voeg toe hoe publiccode.yml wordt toegepast in Nederland -->
...
<Grid>
  ...
  <Card
    appearance="default"
    description="Met de publiccode.yml checker fix je binnen mum van tijd je errors."
    heading="Lint je publiccode.yml met onze checker"
    href="https://developer-overheid-nl.github.io/publiccode-checker"
    linkLabel="Naar de checker"
  />
  <Card
    appearance="default"
    description="Voeg een publiccode.yml toe aan je project met de publiccode.yml editor."
    heading="Publiccode.yml form editor"
    href="/kennisbank/open-source/tools/publiccode-yml-editor"
    linkLabel="Naar artikel"
  />
</Grid>
