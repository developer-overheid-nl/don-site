...
Veel metadata van open source projecten zit opgeslagen in bijvoorbeeld Gitlab of Github. Op het moment dat je de code wilt migreren is het een hoop werk alle gegevens opnieuw in te voeren. Publiccode.yml lost dit voor je op, het bestandje is namelijk onderdeel van je codebase. 
...
<Card
  ...
  linkLabel="Naar artikel over de publiccode.yml editor"
/>
